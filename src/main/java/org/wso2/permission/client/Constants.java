...
public class Constants {
    ...
    public static final String PERMISSSIONS_CSV_FILE = "permisssions.csv.file";
    ...
    public static final String RESOURCE_SERVICE_PATH = "services/ResourceAdminService";
    public static final String PROPERTIES_SERVICE_PATH = "services/PropertiesAdminService";
    ...
    public static final String REGISTRY_PARENT_PATH ="registry.parent.path";
